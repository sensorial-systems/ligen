...
impl Generator<&ligen_idl::Method, anchor_lang_idl_spec::IdlInstruction> for AnchorMethodGenerator {
    fn generate(&self, method: &ligen_idl::Method, _config: &Config) -> Result<anchor_lang_idl_spec::IdlInstruction> {
