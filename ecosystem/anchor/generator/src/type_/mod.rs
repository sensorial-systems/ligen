...
impl Generator<&ligen_idl::Type, anchor_lang_idl_spec::IdlType> for AnchorTypeGenerator {
    fn generate(&self, type_: &ligen_idl::Type, _config: &Config) -> Result<anchor_lang_idl_spec::IdlType> {
