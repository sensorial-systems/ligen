...
// use ligen_parsing::{GetPathTree, Context, Parser, PathTree};
...
//     pub fn new(path_tree: &'a Pin<Box<PathTree<'a>>>) -> Self {
//         let context = Context::from(path_tree);
//         Self { context }
//     }
// }
//
// impl<'a> Parser<RustProject> for ProjectParser<'a> {
//     type Output = Project;
//     fn parse(&self, rust_project: RustProject) -> Result<Self::Output> {
...
//         let module_parser = ModuleParser { context: self.context.clone() };
//         let mut root_module = module_parser.parse(rust_project.root_module)?;
//         module_full_path(&mut root_module, &self.context);
//         object_full_path(&mut root_module);
//         import_full_path(&mut root_module, &self.context);
//         Ok(Self::Output { name, directory, root_module })
//     }
// }
//
...
// }
//
// impl Parser<proc_macro::TokenStream> for ProjectParser<'_> {
//     type Output = RustProject;
...
// }
//
// impl Parser<proc_macro2::TokenStream> for ProjectParser<'_> {
//     type Output = RustProject;
...
//         let mut project = Self::Output { root_folder, root_module };
//         project.parse_modules()?;
//         Ok(project)
//     }
// }
...
//     use ligen_parsing::{Context, GetPathTree, Parser};
//     use ligen_ir::Project;
//     use crate::prelude::*;
//     use pretty_assertions::assert_eq;
//     use ligen_utils::visitors::{ModuleVisitor, ProjectVisitor};
//     use crate::project::{ProjectParser, RustProject};
//     //
//
...
//         let context = Context::from(&path_tree);
//         let parser = ProjectParser { context };
//         let project = parser.parse(rust_project)?;
