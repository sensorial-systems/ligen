...
impl RustTypeAliasParser {
    pub fn new() -> Self {
        Default::default()
    }
}

impl Transformer<proc_macro::TokenStream, TypeDefinition> for RustTypeAliasParser {
...
impl Transformer<proc_macro2::TokenStream, TypeDefinition> for RustTypeAliasParser {
...
impl Transformer<syn::ItemType, TypeDefinition> for RustTypeAliasParser {
...
mod tests {
    ...
    fn type_alias() -> Result<()> {
        assert_eq(RustTypeAliasParser::default(), mock::type_alias(), quote! {
